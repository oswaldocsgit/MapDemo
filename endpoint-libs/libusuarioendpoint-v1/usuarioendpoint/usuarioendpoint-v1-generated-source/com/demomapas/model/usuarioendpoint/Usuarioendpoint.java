...
package com.demomapas.model.usuarioendpoint;
...
public class Usuarioendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUsuario extends UsuarioendpointRequest<com.demomapas.model.usuarioendpoint.model.Usuario> {
    ...
    protected GetUsuario(java.lang.Long id) {
      super(Usuarioendpoint.this, "GET", REST_PATH, null, com.demomapas.model.usuarioendpoint.model.Usuario.class);
   ...
   * operation.
   *
   * @param content the {@link com.demomapas.model.usuarioendpoint.model.Usuario}
   * @return the request
   */
  public InsertUsuario insertUsuario(com.demomapas.model.usuarioendpoint.model.Usuario content) throws java.io.IOException {
    InsertUsuario result = new InsertUsuario(content);
    initialize(result);
    return result;
  }

  public class InsertUsuario extends UsuarioendpointRequest<com.demomapas.model.usuarioendpoint.model.Usuario> {
     ...
     * @since 1.13
     */
    protected InsertUsuario(com.demomapas.model.usuarioendpoint.model.Usuario content) {
      super(Usuarioendpoint.this, "POST", REST_PATH, content, com.demomapas.model.usuarioendpoint.model.Usuario.class);
    }
  ...
  public class ListUsuario extends UsuarioendpointRequest<com.demomapas.model.usuarioendpoint.model.CollectionResponseUsuario> {
    ...
    protected ListUsuario() {
      super(Usuarioendpoint.this, "GET", REST_PATH, null, com.demomapas.model.usuarioendpoint.model.CollectionResponseUsuario.class);
    }
   ...
   * @return the request
   */
  public UpdateUsuario updateUsuario(com.demomapas.model.usuarioendpoint.model.Usuario content) throws java.io.IOException {
    UpdateUsuario result = new UpdateUsuario(content);
    initialize(result);
    return result;
  }

  public class UpdateUsuario extends UsuarioendpointRequest<com.demomapas.model.usuarioendpoint.model.Usuario> {
     ...
     * @since 1.13
     */
    protected UpdateUsuario(com.demomapas.model.usuarioendpoint.model.Usuario content) {
      super(Usuarioendpoint.this, "PUT", REST_PATH, content, com.demomapas.model.usuarioendpoint.model.Usuario.class);
    }
